...
Weryfikacja tej aktualizacji: kontrola składni oraz 43 testy przeszły. Testy obejmują wszystkie 231 dopuszczalnych rozmiarów, obniżone pozycje Stripe, sumę 693 zł za pięć progów, dodatkowy kod, analitykę i odmowę płatności przy różnicach wersji/cen. Bez rzeczywistych obciążeń i zgłoszeń Basin.
