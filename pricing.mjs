...
export const PRICING_VERSION = '2026-08-31-sale30-v3';
...
export const PRICE_BRACKETS = [
  ...
  { min: 61, max: 100, label: '61–100 mm', regularAmount: 14000 },
  { min: 101, max: 150, label: '101–150 mm', regularAmount: 20000 },
  { min: 151, max: 200, label: '151–200 mm', regularAmount: 25000 },
  { min: 201, max: 250, label: '201–250 mm', regularAmount: 32000 }
